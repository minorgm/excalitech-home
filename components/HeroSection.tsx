...
export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-br from-[#0d4b5a] to-[#020230] px-6 py-20 mx-6 rounded-2xl mb-20" aria-label="Hero">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center">
          <img src="/hero_banner_image.svg" alt="Excalitech agency workspace with digital interface on laptop" className="w-full max-w-md" />
        </div>
      </div>
    </section>
  );
