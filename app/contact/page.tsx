...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[#ffffff]">
      <Header />
      <section className="px-6 py-20 rounded-2xl max-w-4xl mx-auto mt-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-1 md:order-1 mb-8 md:mb-0">
            <h1 className="text-4xl font-bold text-[#0f1717] mb-6 text-left">Why Start Your Project With Us?</h1>
